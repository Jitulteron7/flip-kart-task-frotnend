...
const MinCategory = () => {
    return (
        <section style={{display:"flex",justifyContent:"center"}}  className="hidden sm:block bg-white w-full px-2 sm:px-12 overflow-hidden border-b mt-14">
            <div style={{width:"75%"}} className="flex items-center justify-between p-0.5">
                {categories.map((el, i) => (
